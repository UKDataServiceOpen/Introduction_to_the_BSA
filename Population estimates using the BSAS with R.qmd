...
This exercise is part of the ['Getting started with the British Social Attitudes Survey (BSA)'](https://rise.articulate.com/share/dGUdhFV-whQOjnNwFW2rXzp4fM6ZVhXA#/) online module.
...
Data can be downloaded from the [UK Data Service website](https://beta.ukdataservice.ac.uk/datacatalogue/studies/study?id=9005) following a registration. Download the compressed folder, unzip and save it somewhere accessible on your computer.
...
setwd("C:/Users/Your_Username_here/UKDS")
