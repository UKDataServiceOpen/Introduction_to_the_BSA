...
![SPSS output for Frequency distribution of TAXSPEND and EUVOTWHO ](pics/spss_5.PNG){fig-alt="A screenshot of SPPS Output  window showing the output of the EUVOTWHO command for the SERIAL variable"}
...
![SPSS output for Frequency distribution of TAXSPEND and EUVOTWHO ](pics/spss_6.PNG){fig-alt="A screenshot of SPPS Output  window showing the output of the FREQUENCIES command for the TAXSPEND EUVOTWHO variables and EXAMINE VARIABLES for the PenExp2 variable"}
