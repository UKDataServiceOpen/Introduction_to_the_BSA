...
# Getting started 
You can access the BSA 2020 data from the UK Data Service website (following registration).  

Download the folder, unzip and save it somewhere accessible on your computer. 

Once you have the workshop folder saved, set the folder as your working directory in SPSS. To do this, you need to add the correct file path to the folder on your computer to the code below. 

```
* Setting up the working directory
* Change the command below  to match yours: ie typically 
* cd "C:/USERS/Your_Username_here/Your_practicals_folder_here"
* Please note that in the example below the data is located in
